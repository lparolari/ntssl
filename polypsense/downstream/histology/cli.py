...
from polypsense.downstream.histology.engine import train
...
def main():
    ...
    parser.add_argument(
        "--gradient_clip_algorithm", type=str, choices=["norm", "value"]
    )
    ...
    parser.add_argument(
        "--class_mapping", type=str, choices=["ad_vs_hp", "ad_vs_nonad"]
    )
    ...
    # videomae specific
    parser.add_argument("--videomae_pretrained", type=str)
